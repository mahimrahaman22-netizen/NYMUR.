    ...
    <div className="min-h-screen bg-primary selection:bg-neon-blue selection:text-white overflow-x-hidden">
      ...
      <section id="work" className="py-20 px-6 bg-secondary/30">
        <div className="max-w-7xl mx-auto">
          <SectionTitle subtitle="A collection of social media posts, ads, thumbnails, and branding projects.">
            Selected Work
          </SectionTitle>
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            {portfolioItems.map((item, index) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl bg-primary border border-white/5 hover:neon-border cursor-pointer"
              >
                <img 
                  src={item.img} 
                  alt={item.title}
